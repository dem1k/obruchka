...
<?=form_open_multipart('admin/map/create/');?>
...
<table cellspacing="0">
    <tr>
        ...
        <td>
            <input type="text" name="city_ru" value="<?= set_value('city_ru'); ?>"/>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <input type="text" name="city" value="<?= set_value('city'); ?>"/>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <input type="text" name="addr" value="<?= set_value('addr'); ?>"/>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <input type="text" name="addr2" value="<?= set_value('addr2'); ?>"/>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <input type="text" name="x" value="<?= set_value('x'); ?>"/>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <input type="text" name="y" value="<?= set_value('y'); ?>"/>
        </td>
    </tr>
    <tr>
        <td>
